...
if(source_analysis == "Population-based"){
  dat = table_df_pop} else{dat = table_df_WORK}
...
# Save as docx ####
save_as_docx(
  "Table 2: Participant characteristics according to outcome" = final_table, path = here("output", "publication figures", paste0(format(Sys.time(), "%Y-%m-%d-%H%M_"),"Characteristics_outcomes", source_analysis, ".docx")))

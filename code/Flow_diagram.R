...
# inclusion <- tibble(readRDS("P:/ODS/DMCPRU/UEPDATA/Specchio-COVID19/99_data/Base_de_données/Bases_for_sharing/2023-09-20-1819_ALLincsVs0123_ALLparticipants.rds")) %>% 
...
merged_fin <- merged %>% 
  ...
  mutate(
    ...
    # time between inclusion submission and sante-travail
